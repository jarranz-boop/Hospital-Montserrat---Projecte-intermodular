...
def generar_dades_completes():
 ...
 # 3. Infraestructura
  ...
  # 4. Personal (Superclase/Subclase)
    ...
    cur.executemany("INSERT INTO PACIENT (DNI, nom, cognom, telefon, data_naixement) VALUES (%s,%s,%s,%s,%s)", pac>
    ...
    for _ in range(1000):
        ...
        cur.execute("INSERT INTO RESERVA_QUIROFAN (id_quirofan, id_pacient, data, hora) VALUES (%s, %s, %s, %s) RE>
